...
export const sampleTutors: TutorProfile[] = [
  {
    ...
    slug: "jane-smith-gcse-maths-kent",
    town: "Maidstone",
    county: "Kent",
    postcode_area: "ME15",
    ...
    min_rate: 32,
    max_rate: 45,
    short_bio: "Qualified maths teacher supporting GCSE, IGCSE and A-Level students across Kent and online.",
    long_bio:
  ...
  },
  {
    ...
    slug: "ahmed-khan-11-plus-medway",
    town: "Chatham",
    county: "Medway",
    postcode_area: "ME5",
    online_available: true,
